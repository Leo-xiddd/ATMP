...
/**
 * Servlet implementation class ServTestTask
 */
@WebServlet(description = "servlet ServTestTask for atmp service", urlPatterns = { "/servlet/ServTestTask" })
public class ServTestTask extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\atmp\\logconf.properties";
	Logger logger = Logger.getLogger(ServTestTask.class.getName());
	TestTask api = new TestTask();
