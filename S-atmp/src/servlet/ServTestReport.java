...
/**
 * Servlet implementation class ServTestReport
 */
@WebServlet(description = "servlet ServTestReport for atmp service", urlPatterns = { "/servlet/ServTestReport" })
public class ServTestReport extends HttpServlet {
	...
	TestReport api = new TestReport();
	
    public ServTestReport() {
        super();
    }
